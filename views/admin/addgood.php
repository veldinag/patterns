<?php
    switch($status) {
        case 1:
            $status_str = "New product added.";
            break;
        case 2:
            $status_str = "Operation canceled.";
            break;
        case 3:
            $status_str = "New product don't added. Error working with the database.";
            break;
        case 4:
            $status_str = "Please fill in all the fields of the form.";
            break;
        case 5:
            $status_str = "Image loading error.";
            break;
        case 6:
...
<div class="container admin">
    ...
    <div class="admin_wrapper">
        ...
        ?>
        <form action="index.php?path=admin/addgood" method="POST" enctype="multipart/form-data">
                <div class="editproduct">
                    ...
                    <div class="editproduct_imgedit">
                        <div id="preview">
                            <img src="data/img/add-image-icon.png" alt="image">
                        </div>
                        <div>
                    ...
                    <span></span>
                    <div>
                        <button class="editproduct_btn" name="operation" value="add">Add product</button>
